...
void NativeSaver::init(){
	...
	ATTACH_JAVA(env, JNI_VERSION_1_6){
        ...
        NativeSaver::readID = env->GetStaticMethodID(NativeSaver::NativeSaverClass, "read", "(JJ)V");
        NativeSaver::saveID = env->GetStaticMethodID(NativeSaver::NativeSaverClass, "save", "(JJ)V");
        HookManager::addCallback(
            SYMBOL("mcpe", "_ZNK9LevelData10setTagDataER11CompoundTag"), 
